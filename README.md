...
2. Make a .env file
3. Add api key for GOOGLE_MAPS_API_KEY and WEATHER_API(https://www.weatherapi.com/). (you can contact me on whats app : 9315592742 if you don't know how to generate both API keys)
4. Run Yarn add
